...
/* 0xff */
make_group(gp5,
    EX(inc), EMPTY, IDEX(Ja, call), EMPTY,
    IDEX(Ja, jmp), EMPTY, EX(push), EMPTY)
...
static OpcodeEntry opcode_table [512] = {
  ...
  /* 0x68 */	IDEX(push_SI, push), EMPTY, IDEXW(SI, push, 1), EMPTY,
...
/*2 byte_opcode_table */
  ...
  /* 0x94 */	IDEX(E, setcc), IDEXW(E, setcc, 1), EMPTY, EMPTY,
